...
final Map<String, Map<String, String>> translations = {
  'Sinhala': {
    ...
    'Report a Problem':'ගැටලුවක් වාර්තා කරන්න','Contact Admin':'පරිපාලක අමතන්න','My Reports':'මගේ වාර්තා','New Report':'නව වාර්තාව','Support':'සහාය','Support Chat':'සහාය චැට්','Subject':'මාතෘකාව','Description':'විස්තරය','Add Screenshot (Optional)':'තිර රූපයක් එක් කරන්න (විකල්ප)','Screenshot Selected':'තිර රූපය තෝරා ඇත','Report submitted successfully':'වාර්තාව සාර්ථකව යවන ලදී','No reports yet':'තවම වාර්තා නැත','No messages yet':'තවම පණිවිඩ නැත','Status':'තත්ත්වය','In Progress':'ක්‍රියාත්මක වෙමින්','Resolved':'විසඳා ඇත','Rejected':'ප්‍රතික්ෂේප කර ඇත','Please complete all required fields':'අවශ්‍ය සියලු ක්ෂේත්‍ර පුරවන්න','Start a support conversation. You can continue replying here.':'සහාය සංවාදයක් ආරම්භ කරන්න. මෙතැනින්ම පිළිතුරු දිය හැකිය.','Tell us about an issue and track the response':'ගැටලුව ගැන කියා පිළිතුරේ තත්ත්වය බලන්න','Chat with our support team':'අපගේ සහාය කණ්ඩායම සමඟ චැට් කරන්න','Describe the problem clearly so our team can help you faster.':'අපගේ කණ්ඩායමට ඉක්මනින් උදව් කිරීමට ගැටලුව පැහැදිලිව විස්තර කරන්න.','You':'ඔබ','General Support':'සාමාන්‍ය සහාය','Support Request':'සහාය ඉල්ලීම'
  },
  'Tamil': {
    ...
    'Report a Problem':'சிக்கலைப் புகாரளிக்க','Contact Admin':'நிர்வாகியைத் தொடர்புகொள்ள','My Reports':'எனது அறிக்கைகள்','New Report':'புதிய அறிக்கை','Support':'ஆதரவு','Support Chat':'ஆதரவு அரட்டை','Subject':'தலைப்பு','Description':'விளக்கம்','Add Screenshot (Optional)':'திரைப்பிடிப்பைச் சேர்க்கவும் (விருப்பம்)','Screenshot Selected':'திரைப்பிடிப்பு தேர்ந்தெடுக்கப்பட்டது','Report submitted successfully':'அறிக்கை வெற்றிகரமாக அனுப்பப்பட்டது','No reports yet':'அறிக்கைகள் எதுவும் இல்லை','No messages yet':'செய்திகள் எதுவும் இல்லை','Status':'நிலை','In Progress':'செயலில் உள்ளது','Resolved':'தீர்க்கப்பட்டது','Rejected':'நிராகரிக்கப்பட்டது','Please complete all required fields':'தேவையான அனைத்து புலங்களையும் நிரப்பவும்','Start a support conversation. You can continue replying here.':'ஆதரவு உரையாடலைத் தொடங்குங்கள். இங்கே தொடர்ந்து பதிலளிக்கலாம்.','Tell us about an issue and track the response':'சிக்கலைத் தெரிவித்து பதிலின் நிலையைப் பாருங்கள்','Chat with our support team':'எங்கள் ஆதரவு குழுவுடன் அரட்டையடிக்கவும்','Describe the problem clearly so our team can help you faster.':'எங்கள் குழு விரைவாக உதவ சிக்கலைத் தெளிவாக விவரிக்கவும்','You':'நீங்கள்','General Support':'பொதுவான ஆதரவு','Support Request':'ஆதரவு கோரிக்கை'
  }
};
